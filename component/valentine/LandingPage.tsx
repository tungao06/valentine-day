...
const LandingPage = () => {
  ...
  const storyItems: StoryItem[] = [
    ...
    },
    {
      ...
      description: "วันแล้ววันเล่า... ความรู้สึกของพี่ที่มีต่อเธอก็ลึกซึ้งขึ้นเรื่อยๆ เหมือนดอกไม้ที่ค่อยๆ บานสะพรั่งในใจพี่ ทุกครั้งที่ได้กอดเธอ พี่รู้สึกว่าตัวเองเป็นคนที่โชคดีที่สุดในโลกนี้ พี่รักเธอมากกว่าเมื่อวาน แต่จะรักเธอน้อยกว่าพรุ่งนี้เสมอ 🌹",
